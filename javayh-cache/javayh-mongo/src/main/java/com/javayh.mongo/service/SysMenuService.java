package com.javayh.mongo.service;

import com.javayh.common.entity.SysMenu;
import com.javayh.common.id.Uid;
import com.javayh.mongo.repository.MgRepository;
import com.javayh.mongo.repository.SysMenuRepository;
...
public class SysMenuService {
    ...
    public Page<SysMenu> findPag(Pageable pageable) {
        SysMenu sysMenu = SysMenu.builder().code("e").id(Uid.getUid()).pcode(Uid.getUid()).build();
